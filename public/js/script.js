...
detailButtons.forEach((button) => {
    button.addEventListener("click", () => {
        ...
        document.getElementById("preview-harga").textContent =
            "Rp" + button.dataset.harga + " " + "/3 Hari";
        document.getElementById("preview-kategori").textContent =
            button.dataset.kategori;
        document.getElementById("preview-deskripsi").textContent =
            button.dataset.deskripsi;
        document.getElementById("preview-stok").textContent =
            button.dataset.stok;
